 ...
 ?>
    ...
    <div class="container">
      ...
      <nav class="navbar navbar-expand-md navbar-dark bg-dark card-header">
        <a class="navbar-brand" href="index.php"><i class="fas fa-home mr-2"></i>Dall-e photoshop</a>
          ...
          <?php if (Session::get('id') == TRUE) { ?>
            <?php if (Session::get('roleid') == '1') { ?>
              <li class="nav-item">
                  ...
                  <a class="nav-link" href="admin.php"><i class="fas fa-users mr-2"></i>User lists </span></a>
              </li>
              <li class="nav-item
